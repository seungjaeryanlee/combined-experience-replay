...
from agents import NNOnlineQAgent
...
# Setup Agent
q_network = LunarLanderNetwork(100)
optimizer = optim.RMSprop(q_network.parameters(), lr=5e-4)
agent = NNOnlineQAgent(q_network, optimizer, env.observation_space, env.action_space, epsilon=0.1, gamma=1)
...
plt.savefig('images/run_lunarlander_with_online_q_smooth.png')
plt.show()
